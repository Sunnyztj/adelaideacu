...
$('.grid-sort-container').avia_iso_sort();$.avia_utilities.avia_ajax_call()});$.avia_utilities=$.avia_utilities||{};$.avia_utilities.avia_ajax_call=function(container){if(typeof container=='undefined'){container='body'};$('a.avianolink').on('click',function(e){e.preventDefault()});$('a.aviablank').attr('target','_blank');if($.fn.avia_activate_lightbox){$(container).avia_activate_lightbox()}
...
if($.fn.avia_activate_lightbox){current.parents('#main').avia_activate_lightbox()}}}else{var image=$('<img src="'+fallback+'" alt="" title="" />');var lightbox=!1;if('string'==typeof fallback_link&&fallback_link.trim()!=''){image=$('<a href="'+fallback_link.trim()+'" rel="lightbox">'+image+'</a>');lightbox=!0}
if(lightbox&&$.fn.avia_activate_lightbox){current.parents('#main').avia_activate_lightbox()}
