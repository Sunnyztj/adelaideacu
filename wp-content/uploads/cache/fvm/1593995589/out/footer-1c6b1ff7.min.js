(function(){var w=window,C='___grecaptcha_cfg',cfg=w[C]=w[C]||{},N='grecaptcha';var gr=w[N]=w[N]||{};gr.ready=gr.ready||function(f){(cfg.fns=cfg.fns||[]).push(f)};(cfg.render=cfg.render||[]).push('6LfzC7oUAAAAANmGE55cWoNTOL0wuonVWd5B9NKo');w.__google_recaptcha_client=!0;var d=document,po=d.createElement('script');po.type='text/javascript';po.async=!0;po.src='https://www.gstatic.com/recaptcha/releases/NMoy4HgGiLr5NAQaEQa2ho8X/recaptcha__en.js';var e=d.querySelector('script[nonce]'),n=e&&(e.nonce||e.getAttribute('nonce'));if(n){po.setAttribute('nonce',n)}var s=d.getElementsByTagName('script')[0];s.parentNode.insertBefore(po,s)})();
...
lazySizesConfig.loadMode = 1;/*! Magnific Popup - v1.1.0 - 2016-02-20
